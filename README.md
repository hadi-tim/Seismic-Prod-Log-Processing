...
Now days the production logs are generated automatically from the recording unit. Some systems supplied the logs in [XML](https://docs.python.org/3/library/xml.etree.elementtree.html) (Extensible Markup Language) format which makes the QC task difficult.
